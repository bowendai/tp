...
<html lang="en">
	...
	<div>
		...
		<div class="page-content">
			...
			<?php
 require_once './Public/dokuwiki/doku.php'; act_dispatch(); global $ID; for($i = 0; $i < count($autoinfoArr); $i++){ ?>	
				<!--<div class="row">-->
					<div class="col-xs-12">
						<!--<div class="col-sm-3">
							<h2>welcome</h2>
						...
						<h2 class="header smaller lighter blue">
							<a href="/thinkphp_3.2.3_core_extend/index.php/Home/autodesign/detail?id=<?php echo ($verArr[$i]['id']); ?>"><?php echo ($autoinfoArr[$i]["title"]); ?></a>
