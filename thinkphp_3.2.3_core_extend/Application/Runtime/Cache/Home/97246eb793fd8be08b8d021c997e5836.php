		...
		<script>
			...
			$(document).ready(function() { 				
				...
				$("#edbtn__cancel").click(function(){
					...
					$('#dw__editform').attr('action', '/thinkphp_3.2.3_core_extend/index.php/Home/Autodesign/detail?id='+verid);
				...
				$("#edbtn__preview").click(function(){
					...
					$('#dw__editform').attr('action', '/thinkphp_3.2.3_core_extend/index.php/Home/Autodesign/edit?id='+verid+'&do=preview');
					
				});
				
				//保存按钮
				$("#edbtn__save").click(function(){
					$('#dw__editform').attr('action', '/thinkphp_3.2.3_core_extend/index.php/Home/Autodesign/add?id='+verid);
				});
